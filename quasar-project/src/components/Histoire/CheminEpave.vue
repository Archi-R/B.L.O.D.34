<template>
    <q-page class="flex flex-center">
        ...
        En effet l'eau dans laquelle il se trouvait était contaminée par de l'artillerie se trouvant dans une autre piece.
        Cette artillerie était majoritairement composé de plomb. Après avoir découvert cette eau il s'éloigna autant que possible de cette pièce.
