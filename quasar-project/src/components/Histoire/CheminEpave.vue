<template>
    <q-page class="flex flex-center">
        ...
        Se dirigeant vers cette ouverture il découvrit alors toute une vie marine qui se trouvait logée dans cet espace qui n'avait rien de naturel.<br>
        Lors de cette exploration il s'est approché d'une salle; de cette salle émanait une eau des plus déplaisante.<br>
        En effet l'eau dans laquelle il se trouvait était contaminée par de l'artillerie se trouvant dans une autre pièce.<br>
        Cette artillerie était majoritairement composée de plomb. Après avoir découvert cette eau il s'éloigna autant que possible de cette pièce.<br>
        Il semblerait que même si ces épaves peuvent être source d'habitat pour les habitants de l'eau certaines d'entre elles poseront des problèmes tôt ou tard.<br>
        Avec de la chance les humains finiront par s'occuper des épaves qu'ils ont éparpillé sur les sols marins avant que les plus problématiques ne soient source d'un empoisonnement général de la faune et la flore environnantes.<br>
        </p>
