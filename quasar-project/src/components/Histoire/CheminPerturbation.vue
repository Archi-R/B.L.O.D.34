<template>
    <q-page class="flex flex-center">
        <h1>Perturbation</h1>
        <p class="texte">Azuré est témoin de la perturbation de son propre environnement à mesure que les activités humaines continuent de modifier son habitat naturel.<br>
